          ...
          >
            ...
            >
              ...
              >
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {proof.map((p) => (
                        <div key={p.id} className="fr-avoid overflow-hidden rounded border border-black/10">
                          ...
                          <p className="px-2 py-1.5 text-[11.5px] text-bark-500">
                ...
                <p className="mt-6 border-t border-black/10 pt-3 text-center text-[11.5px] text-bark-400">
                  Generated by StrayPaw · community-verified street-dog data · straypaw.org
                </p>
              </div>
            </motion.div>
          </motion.div>
...
function Stat({ value, label, big }: { value: string; label: string; big?: boolean }) {
  return (
    <div className="rounded bg-bark-50 p-3 text-center">
      ...
      <p className="text-[11.5px] text-bark-500">{label}</p>
    </div>
  );
}
