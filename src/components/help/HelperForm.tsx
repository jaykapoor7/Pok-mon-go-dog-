            ...
            {done ? (
              ...
              <>
                ...
                <form onSubmit={submit} className="mt-4 space-y-3">
                  ...
                  <p className="text-center text-[11.5px] text-bark-400">Run an organisation? <a href="/for-ngos" className="font-semibold text-paw-600">Partner with StrayPaw</a> instead.</p>
                </form>
              </>
            )}
          </motion.div>
