    ...
    <>
      ...
      <style jsx global>{`
        .sp-map-detail {
          ...
          box-shadow: 0 18px 50px rgba(11, 30, 61, 0.22) !important;
        }
        .sp-map.has-selection .sp-map-controls { right: 16px !important; }
        @media (max-width: 800px) {
          ...
          .sp-map.has-selection .sp-map-controls { right: 12px !important; }
        }
      `}</style>
    </>
  );
