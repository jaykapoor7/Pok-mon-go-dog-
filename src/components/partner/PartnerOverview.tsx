  ...
  return (
    <div className="partner-overview">
      ...
      <section className="partner-analysis" aria-label="Programme patterns">
        <div className="partner-analysis-heading"><span>Patterns in the programme</span><p>New casework, and where it is concentrating.</p></div>
...
function Stat({ label, value, detail, tone }: { label: string; value: number | string; detail: string; tone?: string }) {
  /* The tile is sized for a figure. When there is no figure to show it
     ...
     than at the display size, which would have run the old "No data"
     off the column. */
