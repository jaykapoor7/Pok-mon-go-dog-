...
export function TakeActionClient() {
  ...
  return (
    <div>
      ...
      {/* Who's working here */}
      <div className="mt-8 flex flex-col items-start justify-between gap-4 rounded-2xl border border-black/[0.08] p-6 dark:border-white/[0.1] sm:flex-row sm:items-center">
        <div>
          <h2 className="font-display text-xl font-bold tracking-tight">Who&apos;s working in {state.name}?</h2>
          <p className="mt-1 text-sm text-bark-600 dark:text-bark-300">Find welfare organisations and community efforts, or add your observations to the map.</p>
        </div>
        <div className="flex shrink-0 gap-3">
          <Link href="/orgs" className="btn-ghost px-5 py-3">Organisations</Link>
