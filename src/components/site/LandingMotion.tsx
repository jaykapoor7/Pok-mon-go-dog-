...
export function LandingMotion() {
  useEffect(() => {
    ...
    const setup = () => {
      ...
      const sections = root.querySelectorAll<HTMLElement>(".field-section-heading, .field-steps article, .field-team-copy, .field-workspace-example, .field-paths a, .field-photo-story, .field-closing h2, .record-stage, .record-intro-copy, .cx-head, .cx-rail, .cm");
