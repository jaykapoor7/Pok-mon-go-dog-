...
export const RESEARCH: ResearchEntry[] = [
  ...
  {
    id: "jaipur-abc-study",
    title: "Impact of ABC on street dog population and rabies in Jaipur",
    org: "Help in Suffering / peer-reviewed (WHO Bulletin and others)",
    year: 2007,
    geography: "Jaipur, Rajasthan",
    type: "research",
    topics: ["ABC", "effectiveness", "rabies"],
    summary: "Long-term study of Jaipur's ABC programme (operational since 1994) showing sustained reductions in street-dog density and elimination of human rabies deaths in the programme area over a decade of continuous sterilisation and vaccination.",
    url: "https://www.who.int/bulletin/volumes/85/6/06-030825/en/",
  },
  {
    id: "one-health-rabies",
    title: "One Health approach to rabies elimination in India",
    org: "National Institute of Mental Health and Neuro Sciences (NIMHANS) / collaborators",
    year: 2022,
    geography: "India",
    type: "research",
    topics: ["rabies", "vaccination", "policy", "One Health"],
    summary: "Advocates for coordinated human-animal health strategies for rabies elimination, noting that dog vaccination alone at 70%+ coverage is the most cost-effective intervention.",
  },
  {
    id: "prevention-cruelty-act",
    title: "Prevention of Cruelty to Animals Act, 1960",
    org: "Government of India",
    year: 1960,
    geography: "India",
    type: "government",
    topics: ["policy", "welfare", "legal framework"],
    summary: "The foundational legislation governing animal welfare in India, establishing the Animal Welfare Board of India (AWBI) and defining cruelty offences. ABC Rules and AWBI guidelines are issued under this act.",
  },
  {
    id: "dog-bite-management-guidelines",
    title: "National Guidelines for Management of Animal Bites",
    org: "National Centre for Disease Control (NCDC)",
    year: 2024,
    geography: "India",
    type: "government",
    topics: ["rabies", "post-bite", "public health"],
    summary: "Updated national clinical guidelines on post-exposure prophylaxis (PEP) for animal bites, including wound management, vaccination schedules, and immunoglobulin use.",
    url: "https://ncdc.mohfw.gov.in/index4.php?lang=1&level=0&linkid=460&lid=3739",
  },
  {
    id: "livestock-census-21",
    title: "21st Livestock Census (announced)",
    org: "Dept. of Animal Husbandry & Dairying (DAHD)",
    year: 2025,
    geography: "India",
    type: "government",
    topics: ["population", "census"],
    summary: "India's next decennial livestock census, which will update the 2019 street-dog population baseline. Previous census found 15.3 million stray dogs nationally.",
  },
];
